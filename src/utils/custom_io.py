...
def create_date_model_folder(parent_folder, model_name, config=None):
    ...
    if config:
        ...
        if (
            ...
            os.makedirs(folder_path + "/params", exist_ok=True)
    return folder_path
